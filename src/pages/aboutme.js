  ...
  <Layout>
    ...
    <div id="AboutContent" className="About">
      ...
      <div className="AboutGroup">
        <h1>Hi, I'm Felipe.</h1>
        <p>I'm a generalist who enjoys solving problems and learning from every challenge. I have a unique business background from my studies at DeGroote Business School and previously at KPMG. <br/> <br/>When it comes to work, I'm a team player who thrives in collaborative environments. I want to be involved in projects that I find challenging alongside people that inspire me. 
        ...
        <a href="https://25iq.com/2017/12/30/moviepass-premature-scaling/" target="_blank" rel="noopener noreferrer"> Tren Griffin Valuing SaaS Companies </a>
        </ul>
